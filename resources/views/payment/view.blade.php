...
<p>Bedrag betaald door: {{$transaction->zender_email}}: <strong>{{$transaction->bedrag}} niksen</strong></p><br>
@elseif($transaction->geaccepteerd == 0)
<p>Bedrag te betalen door {{$transaction->ontvanger_email}}: <strong> {{$transaction->bedrag}} niksen</strong></p><br>
...
@endif
@else
<p>Bedrag betaald door: {{$transaction->ontvanger_email}}: <strong>{{$transaction->bedrag}} niksen</strong></p><br>
